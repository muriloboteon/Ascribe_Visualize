...
// Interactive Component for each Highlight
const InteractiveHighlight = ({
    ...
    const activator = (
        <span
            ...
            style={{
                backgroundColor: active ? '#ffd6a4' : 'rgba(69, 79, 91, 0.12)',
                color: '#202223',
                padding: '2px 4px',
                margin: '0 2px',
                borderRadius: '4px',
                fontWeight: '500',
                borderBottom: '1px dashed #5c5f62',
                cursor: 'pointer',
    ...
    return (
        <Popover
            ...
            zIndexOverride={6000} // Ensure it appears above other elements if needed
        >
            <div
                onMouseEnter={handleMouseEnter} // Keep open when hovering the popover itself
                onMouseLeave={handleMouseLeave}
...
const HighlightedTextWithTooltip = ({
    text,
    codes
}: {
    text: string,
    codes?: Array<{ segment: string, code: string, idea: string }>
}) => {
...
export function ResponseDrawerTooltip({ isOpen, onClose }: ResponseDrawerProps) {
            ...
            <div style={{
                ...
                {viewMode !== 'list' && selectedComment ? (
                    ...
                    <div style={{ paddingRight: '16px' }}>
                        <Text as="h2" variant="headingMd">Response Drawer (V2 - Tooltip)</Text>
                    </div>
                )}
            ...
            {viewMode === 'details' && selectedComment ? (
                <div style={{ flex: 1, overflowY: 'auto', padding: '20px', backgroundColor: '#fff' }}>
                    <BlockStack gap="500">
                        ...
                        {/* Applied Codes Section (Visual List - still useful for overview) */}
                        <div style={{ padding: '16px', border: '1px solid #e1e3e5', borderRadius: '8px' }}>
                            <BlockStack gap="300">
                                <Text as="h3" variant="headingXs">Applied Codes (Overview)</Text>
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                                    {selectedComment.codes?.map((item, index) => (
                                        <div key={index} style={{
                                            ...
                                            <Text as="span" variant="bodyMd">{item.code}</Text>
                                            <div
                                                role="button"
                                    ...
                                    >
                                        <div style={{ marginBottom: '8px' }}>
                                            <Text as="p" variant="bodyMd">
                                                ...
                                                <HighlightedTextWithTooltip text={comment.text} codes={comment.codes ? [comment.codes[0]] : []} />
                                            </Text>
                                        </div>
